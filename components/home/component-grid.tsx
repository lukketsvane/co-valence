    ...
    <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
      ...
      >
        <button
          ...
          className="flex w-36 items-center justify-between rounded-md border border-gray-300 px-4 py-2 transition-all duration-1000 hover:border-gray-800 focus:outline-none active:bg-gray-100"
        >
      ...
      <Tooltip content="Co:valence is an opinionated collection of components, hooks, and utilities for your Next.js project.">
        <div className="flex w-36 cursor-default items-center justify-center rounded-md border border-gray-300 px-3 py-2 transition-all duration-750 hover:border-gray-800 focus:outline-none active:bg-gray-100">
